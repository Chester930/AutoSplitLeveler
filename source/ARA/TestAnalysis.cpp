...
static const AutoSplitLevelerAlgorithm autoSplitLevelerAlgorithm;
/*******************************************************************************/

std::vector<const TestProcessingAlgorithm*> const& TestProcessingAlgorithm::getAlgorithms ()
{
    static const std::vector<const TestProcessingAlgorithm*> algorithms { &autoSplitLevelerAlgorithm, &percussiveAlgorithm, &monophonicAlgorithm, &polyphonicAlgorithm, &singleNoteAlgorithm };
    return algorithms;
}
...
const TestProcessingAlgorithm* TestProcessingAlgorithm::getDefaultAlgorithm ()
{
    ...
    return &autoSplitLevelerAlgorithm;
}
